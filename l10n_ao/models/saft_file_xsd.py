...
<xs:schema xmlns:doc="urn:schemas-basda-org:schema-extensions:documentation" 
  ...
  <xs:element name="NumberOfEntries" type="xs:nonNegativeInteger">
    <xs:annotation>
      <xs:documentation>
        Deve conter o número total de documentos ou de movimentos, caso respeite o elemento GeneralLedgerEntries.
      </xs:documentation>
    </xs:annotation>
  </xs:element>
  ...
  <xs:simpleType name="PaymentTaxCode">
    <xs:restriction base="xs:string">
      <xs:pattern value="RED|NOR|ISE|OUT|([0-9.])*|NA|NS" />
      <xs:minLength value="1" />
  ...
  <xs:element name="TaxCode">
    ...
    <xs:simpleType>
      <xs:restriction base="xs:string">
        <xs:pattern value="RED|NOR|ISE|OUT|([0-9.])*|NS|NA" />
        <xs:minLength value="1" />
        <xs:maxLength value="10" />
      </xs:restriction>
    </xs:simpleType>
  ...
  <xs:simpleType name="SAFTAOMovementTaxCode">
    ...
    <xs:restriction base="xs:string">
      <xs:pattern value="RED|NOR|ISE|OUT|NS|NA" />
      <xs:minLength value="1" />
